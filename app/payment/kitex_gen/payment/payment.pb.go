...
func (x *ChargeReq) GetAmount() float64 {
	if x != nil {
		return x.Amount
	}
	return 0
...
func (x *ChargeReq) GetOrderId() uint64 {
	if x != nil {
		return x.OrderId
	}
	return 0
...
var file_payment_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x04, 0x52, 0x07, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x49, 0x64, 0x12, 0x17, 0x0a, 0x07,
	...
	0x70, 0x2f, 0x70, 0x61, 0x79, 0x6d, 0x65, 0x6e, 0x74, 0x2f, 0x6b, 0x69, 0x74, 0x65, 0x78, 0x5f,
