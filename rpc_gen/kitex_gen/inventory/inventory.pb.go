...
type InventoryReq struct {
	...
	OrderId uint64               `protobuf:"varint,1,opt,name=order_id,json=orderId,proto3" json:"order_id,omitempty"` // 订单号（全局唯一）
...
func (x *InventoryReq) GetOrderId() uint64 {
	if x != nil {
		return x.OrderId
	}
	return 0
...
type ProductUpdateEvent struct {
	...
	SkuId    uint64 `protobuf:"varint,1,opt,name=sku_id,json=skuId,proto3" json:"sku_id,omitempty"`
	SkuName  string `protobuf:"bytes,2,opt,name=sku_name,json=skuName,proto3" json:"sku_name,omitempty"`
	AddStock int32  `protobuf:"varint,3,opt,name=add_stock,json=addStock,proto3" json:"add_stock,omitempty"`
	Operator string `protobuf:"bytes,4,opt,name=operator,proto3" json:"operator,omitempty"`
}

func (x *ProductUpdateEvent) Reset() {
	*x = ProductUpdateEvent{}
	if protoimpl.UnsafeEnabled {
...
func (x *ProductUpdateEvent) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ProductUpdateEvent) ProtoMessage() {}

func (x *ProductUpdateEvent) ProtoReflect() protoreflect.Message {
	mi := &file_inventory_proto_msgTypes[5]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ProductUpdateEvent.ProtoReflect.Descriptor instead.
func (*ProductUpdateEvent) Descriptor() ([]byte, []int) {
	return file_inventory_proto_rawDescGZIP(), []int{5}
}

func (x *ProductUpdateEvent) GetSkuId() uint64 {
	if x != nil {
		return x.SkuId
	}
	return 0
...
func (x *ProductUpdateEvent) GetSkuName() string {
	if x != nil {
		return x.SkuName
	}
	return ""
...
func (x *ProductUpdateEvent) GetAddStock() int32 {
	if x != nil {
		return x.AddStock
	}
	return 0
...
func (x *ProductUpdateEvent) GetOperator() string {
	if x != nil {
		return x.Operator
	}
	return ""
...
func (x *ProductDeleteEvent) Reset() {
	*x = ProductDeleteEvent{}
	if protoimpl.UnsafeEnabled {
...
func (x *ProductDeleteEvent) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ProductDeleteEvent) ProtoMessage() {}

func (x *ProductDeleteEvent) ProtoReflect() protoreflect.Message {
	mi := &file_inventory_proto_msgTypes[6]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ProductDeleteEvent.ProtoReflect.Descriptor instead.
func (*ProductDeleteEvent) Descriptor() ([]byte, []int) {
	return file_inventory_proto_rawDescGZIP(), []int{6}
}

func (x *ProductDeleteEvent) GetSkuId() uint64 {
	if x != nil {
		return x.SkuId
	}
	return 0
...
func (x *ProductDeleteEvent) GetSkuName() string {
	if x != nil {
		return x.SkuName
	}
	return ""
...
func (x *ProductDeleteEvent) GetOperator() string {
	if x != nil {
		return x.Operator
	}
	return ""
...
func (x *InventoryReq_Item) GetQuantity() uint32 {
	if x != nil {
		return x.Quantity
	}
	return 0
...
var file_inventory_proto_rawDesc = []byte{
	...
	0x0d, 0x52, 0x08, 0x71, 0x75, 0x61, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x22, 0x9b, 0x01, 0x0a, 0x0d,
	...
	,
	...
	,
	...
	0x6f, 0x72, 0x79, 0x52, 0x65, 0x73, 0x70, 0x12, 0x41, 0x0a, 0x0c, 0x52, 0x65, 0x6c, 0x65, 0x61,
	0x73, 0x65, 0x53, 0x74, 0x6f, 0x63, 0x6b, 0x12, 0x17, 0x2e, 0x69, 0x6e, 0x76, 0x65, 0x6e, 0x74,
	...
	0x65, 0x6e, 0x74, 0x6f, 0x72, 0x79, 0x52, 0x65, 0x73, 0x70, 0x42, 0x36, 0x5a, 0x34, 0x67, 0x69,
	0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x59, 0x7a, 0x63, 0x32, 0x31, 0x36, 0x2f,
...
var file_inventory_proto_goTypes = []interface{}{
	...
	(*ProductUpdateEvent)(nil),  // 5: inventory.ProductUpdateEvent
	(*ProductDeleteEvent)(nil),  // 6: inventory.ProductDeleteEvent
	nil,                         // 7: inventory.QueryStockResp.CurrentStockEntry
	(*InventoryReq_Item)(nil),   // 8: inventory.InventoryReq.Item
	(*InventoryResp_Error)(nil), // 9: inventory.InventoryResp.Error
}
var file_inventory_proto_depIdxs = []int32{
	7, // 0: inventory.QueryStockResp.current_stock:type_name -> inventory.QueryStockResp.CurrentStockEntry
	8, // 1: inventory.InventoryReq.items:type_name -> inventory.InventoryReq.Item
	9, // 2: inventory.InventoryResp.errors:type_name -> inventory.InventoryResp.Error
...
func file_inventory_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_inventory_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ProductUpdateEvent); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_inventory_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ProductDeleteEvent); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
